...
import Logo from "@/public/assets/assets/img/logo.png";
  ...
  return (
    ...
    >
      <div className="container mx-auto h-full flex items-center justify-between">
        {/* logo */}
        <Link href="">
          <Image src={Logo} width={117} height={55} alt="" />
        </Link>
        ...
        flex flex-col text-center gap-8 fixed
         bg-primary-200 w-full left-0  text-base uppercase
          font-medium text-white transition-all xl:hidden`} />
        {/* desktop nav -hidden on small devices */}
        <Nav containerStyles=" py-12 flex gap-4 text-white text-base uppercase font-medium  transition-all hidden xl:flex" />
